                ...
                {approvedReviews.map((review) => (
                  <Card key={review.id}>
                    ...
                    <CardContent>
                      ...
                      {review.product && (
                        <Link href={`/products/$${review.product.slug}`} className="text-xs text-primary hover:underline block mb-3">
                          {review.product.name}
                        </Link>
                      )}
                      <Button 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {approvedTestimonials.map((t) => (
                  <Card key={t.id}>
                    ...
                    <CardContent>
                      <p className="text-sm text-muted-foreground line-clamp-3 mb-3">{t.comment}</p>
                      <Button 
                        variant="outline" 
                        size="sm" 
