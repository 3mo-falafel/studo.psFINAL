...
export async function PUT(
  ...
  try {
    ...
    console.log("Approving testimonial (cleaned):", testimonialId)
    ...
    console.log("User is admin, approving testimonial")
    ...
    return NextResponse.json(
      { error: "Failed to approve testimonial", details: String(error) },
      { status: 500 }
    )
  }
}
