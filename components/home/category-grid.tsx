...
const categoryImages: Record<string, string> = {
  ...
  "hard-disks": "https://shop.sandisk.com/content/dam/store/en-us/assets/products/usb-flash-drives/extreme-pro-dual-drive-usb/gallery/sandisk-extreme-pro-dual-drive-usb-front.png",
...
const categoryGradients: Record<string, string> = {
  ...
  chargers: "from-white via-white to-white",
  "hard-disks": "from-white via-white to-white",
  "printed-stuff": "from-[#4A9B8E]/30 via-[#4A9B8E]/20 to-[#3D8B7E]/30",
  "gift-packages": "from-[#4A9B8E]/30 via-[#4A9B8E]/20 to-[#3D8B7E]/30",
  bags: "from-white via-white to-white",
}
